...
/**
 * Implements a renderable forum post mail in plain text
 *
 * @package   mod_forum
 * @copyright 2015 Nine Lanterns {@link http://ninelanterns.com.au/}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class forum_post_mail_text implements \renderable {
     ...
     */
    public function __construct($course, $cm, $forum, $discussion, $post, $userfrom, $userto, $bare = false, $replyaddress = null) {
        $this->course = $course;
        $this->cm = $cm;
        $this->forum = $forum;
...
/**
 * Implements a renderable forum post in HTML, for inclusion in mail or digest
 *
 * @package   mod_forum
 * @copyright 2015 Nine Lanterns {@link http://ninelanterns.com.au/}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class forum_post_html implements \renderable {
     ...
     * @param string $footer
     */
    public function __construct($course, $cm, $forum, $discussion, $post,
            $userfrom, $userto, $ownpost=false, $reply=false, $link=false, $rate=false, $footer="") {
        $this->course = $course;
        $this->cm = $cm;
        $this->forum = $forum;
        $this->discussion = $discussion;
